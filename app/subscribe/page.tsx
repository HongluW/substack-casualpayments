        ...
        <div className="flex justify-center gap-4 mb-8">
          {planTypeTabs.map(tab => (
            <button
              key={tab}
              type="button"
              className={`px-4 py-2 rounded font-medium border transition-colors whitespace-nowrap ${selectedTab === tab ? "bg-gray-100 border-gray-400" : "bg-white border-gray-200 text-gray-500"}`}
