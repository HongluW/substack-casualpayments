  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center w-full min-h-[calc(100vh-80px)]">
        <div className="w-full max-w-2xl px-4 pt-20 pb-8">
          {/* Title */}
          ...
          <div className="pt-8 pb-4">
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Monthly plan price</div>
                <div className="text-xs text-gray-500">The amount monthly paid subscribers pay per month.</div>
              </div>
              <div className="flex items-center gap-2">
                <input type="text" value={monthly} onChange={e => setMonthly(e.target.value)} className="w-20 px-2 py-1 border rounded text-right text-sm" />
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Annual plan price</div>
                <div className="text-xs text-gray-500">The amount annual paid subscribers pay per year.</div>
              </div>
              <div className="flex items-center gap-2">
                <input type="text" value={annual} onChange={e => setAnnual(e.target.value)} className="w-20 px-2 py-1 border rounded text-right text-sm" />
                <select value={currency} onChange={e => setCurrency(e.target.value)} className="border rounded px-2 py-1 text-sm">
                  {currencies.map(cur => <option key={cur} value={cur.toUpperCase()}>{cur.toUpperCase()}</option>)}
                </select>
              </div>
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Founding plan price</div>
              ...
              <div className="flex items-center gap-2">
                <input type="text" value={founding} onChange={e => setFounding(e.target.value)} className="w-20 px-2 py-1 border rounded text-right text-sm" />
                <select value={currency} disabled className="border rounded px-2 py-1 text-sm bg-gray-100">
                  {currencies.map(cur => <option key={cur} value={cur.toUpperCase()}>{cur.toUpperCase()}</option>)}
                </select>
              </div>
            </div>
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Founding plan name</div>
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4 justify-between">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Flexible founding plan pricing</div>
          ...
          <div className="pt-8 pb-4">
            ...
            <div className="mb-4">
              <div className="font-semibold text-sm">Free subscriber benefits</div>
            ...
            <div className="mb-4">
              <div className="font-semibold text-sm">Paid subscriber benefits</div>
            ...
            <div className="mb-4">
              <div className="font-semibold text-sm">Founding member benefits</div>
          ...
          <div className="pt-8 pb-4">
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Minimum group size</div>
              </div>
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Group subscription discount</div>
          ...
          <div className="pt-8 pb-4">
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Enable in-app payments</div>
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Accept direct debit payments</div>
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Automatically localize prices</div>
            ...
            <div className="flex flex-row gap-5 min-h-12 items-center mb-4">
              <div className="flex flex-col flex-grow gap-0.5">
                <div className="font-semibold text-sm">Supported currencies</div>
          ...
          {/* Footer button group at the end of content */}
          <div className="w-full flex flex-col gap-4 py-6 mt-8 px-0 bg-white">
